...
const savedTheme = localStorage.getItem('dhairya-portfolio-theme') || 'midnight';
...
function setTheme(name) {
    ...
    localStorage.setItem('dhairya-portfolio-theme', name);
...
function initThemeSelector(win) {
    ...
    const currentTheme = localStorage.getItem('dhairya-portfolio-theme') || 'midnight';
